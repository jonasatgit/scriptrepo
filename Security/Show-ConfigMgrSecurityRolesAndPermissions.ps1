...
if($selectedRoles.Count -gt 0)
{
    ...
    $outObj | Select-Object RoleName, CopiedFrom, ObjectTypeIsPartOfRole, ObjectTypeName, OperationName, Allow | Out-GridView -Title 'List of MECM security roles and permissions'
}
else 
{
